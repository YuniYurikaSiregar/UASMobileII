...
class App04 memperluas StatelessWidget {
  Pembuatan widget (konteks BuildContext) {
    kembalikan MaterialApp(
      rute: {
        "Data": (konteks) => YuniYUrikaDataTable(),
      ...
      rumah: Perancah (
        appBar: AppBar(
          judul: Teks('UAS-Yuni Yurika (6SIA4)'),
        ),
        isi: Halaman Masuk(),
      ),
    );
...
class YuniYurikaDataTable memperluas StatefulWidget {
  _YuniYurikaDataTableState createState() => _YuniYurikaDataTableState();
}

class _YuniYurikaDataTableState memperluas State<YuniYurikaDataTable> {
...
kelas DataMahasiswa {
  ...
  static Daftar<DataMahasiswa> getDataBarang() {
    kembalikan <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Yuni Yurika", ),
      DataMahasiswa(
          id: "Jenis Kelamin", namabarang: "perempuan", ),
      DataMahasiswa(id: "Alamat", namabarang: "Jl.Damar XII No 26", ),
      DataMahasiswa(
